...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003ce:	0af76163          	bltu	a4,a5,80200470 <interrupt_handler+0xac>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200434:	e715                	bnez	a4,80200460 <interrupt_handler+0x9c>
    80200436:	6018                	ld	a4,0(s0)
    80200438:	47a5                	li	a5,9
    8020043a:	02e7e363          	bltu	a5,a4,80200460 <interrupt_handler+0x9c>
    cprintf("%d ticks\n", TICK_NUM);
    8020043e:	06400593          	li	a1,100
    80200442:	00001517          	auipc	a0,0x1
    80200446:	afe50513          	addi	a0,a0,-1282 # 80200f40 <etext+0x510>
    8020044a:	c27ff0ef          	jal	ra,80200070 <cprintf>
            {
              print_ticks();
              num++;
    8020044e:	601c                	ld	a5,0(s0)
    80200450:	0785                	addi	a5,a5,1
    80200452:	e01c                	sd	a5,0(s0)
    80200454:	a811                	j	80200468 <interrupt_handler+0xa4>
            break;
        case IRQ_U_EXT:
            cprintf("User software interrupt\n");
            break;
    ...
    8020045a:	afa50513          	addi	a0,a0,-1286 # 80200f50 <etext+0x520>
    8020045e:	b909                	j	80200070 <cprintf>
            else if(num == 10){
    80200460:	6018                	ld	a4,0(s0)
    80200462:	47a9                	li	a5,10
    80200464:	00f70763          	beq	a4,a5,80200472 <interrupt_handler+0xae>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    8020046e:	8082                	ret
            print_trapframe(tf);
    80200470:	bdd5                	j	80200364 <print_trapframe>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    80200492:	02e79563          	bne	a5,a4,802004bc <exception_handler+0x42>
             /* LAB1 CHALLENGE3   YOUR CODE : 2211555 */
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200604:	a3078793          	addi	a5,a5,-1488 # 80201030 <etext+0x600>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200660:	a08a8a93          	addi	s5,s5,-1528 # 80201064 <etext+0x634>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200668:	bdcb8b93          	addi	s7,s7,-1060 # 80201240 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008be:	7a660613          	addi	a2,a2,1958 # 80201060 <etext+0x630>
    ...
    802008d0:	78460613          	addi	a2,a2,1924 # 80201050 <etext+0x620>
    ...
    802008e2:	76a40413          	addi	s0,s0,1898 # 80201048 <etext+0x618>
    ...
    8020096c:	6e040413          	addi	s0,s0,1760 # 80201048 <etext+0x618>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200982:	6cba0a13          	addi	s4,s4,1739 # 80201049 <etext+0x619>
